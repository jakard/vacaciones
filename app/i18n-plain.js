...
export const PLAIN = {
  ...
  'Treasure Chest': { en: 'Wallet', es: 'Cartera' },
  ...
  'A crewmate': { en: 'A teammate', es: 'Un compañero' },
  'Bounty Board': { en: 'Requests', es: 'Solicitudes' },
  'Post Bounty': { en: 'New request', es: 'Nueva solicitud' },
  ...
  'Crew navigation': { en: 'Team navigation', es: 'Navegación del equipo' },
  ...
  'Took 1 day. {n} doubloons in escrow.': { en: 'Took 1 day. {n} credits held.', es: 'Tomaste 1 día. {n} créditos retenidos.' },
  'Took {d} days. {n} doubloons in escrow.': { en: 'Took {d} days. {n} credits held.', es: 'Tomaste {d} días. {n} créditos retenidos.' },
